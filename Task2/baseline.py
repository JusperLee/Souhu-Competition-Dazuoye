...
def get_feature_columns():
    ...
    feed_embedding = fc.embedding_column(feed_cate, FLAGS.embed_dim, max_norm=FLAGS.embed_l2)
    city_cate_embedding = fc.embedding_column(city_cate, FLAGS.embed_dim, max_norm=FLAGS.embed_l2)
    os_embedding = fc.embedding_column(os_cate, 32, max_norm=FLAGS.embed_l2)
    province_embedding = fc.embedding_column(province_cate, 32, max_norm=FLAGS.embed_l2)
    device_embedding = fc.embedding_column(device_cate, 32, max_norm=FLAGS.embed_l2)
    browser_embedding = fc.embedding_column(browser_cate, 32, max_norm=FLAGS.embed_l2)
    feature_columns.append(user_embedding)
    feature_columns.append(feed_embedding)
    feature_columns.append(city_cate_embedding)
