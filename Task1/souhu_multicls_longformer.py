...
OUTPUT_DIR = './souhu_multicls_longformer/'
...
test_corpus, test_entitys, test_ids = get_test_data(input_file='./data/recommend.txt')
    ...
    for fold in range(CFG.n_fold):
        ...
        for inputs in tk0:
            ...
            with torch.no_grad():
                ...
                # import pdb; pdb.set_trace()
                y_pred_pa_all = torch.nn.parallel.data_parallel(model, inputs, device_ids=[0,1,2,3])
